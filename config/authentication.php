...
$config['table_users'] = 'cta_users';
$config['table_groups'] = 'cta_user_groups';
$config['table_profiles'] = 'cta_user_profiles';
...
$config['email_subject_3'] = 'A new user has registered';
